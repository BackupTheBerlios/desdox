...
#define ENTRY_KIND_OF_ENTRY   "entry_kind_of_entry"
#define ENTRY_IS_SERIAL       "entry_is_serial"
#define ENTRY_PRIORITY        "entry_priority"
#define ENTRY_TITLE           "entry_title"
#define ENTRY_DESCRIPTION     "entry_description"
#define ENTRY_RANGE           "entry_range"


#define REG_ACQ_ENVIRONMENT   1
#define CLASS_ANY             0 // for packages and registering attributes

#define ROOM_SCORM_HOME       "room_scorm_home"    //CP
#define ROOM_SCORM_VISIT      "room_scorm_visit"   //CP
